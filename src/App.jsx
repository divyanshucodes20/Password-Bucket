    ...
    <>
      ...
      <div className=" md:mx-auto md:max-w-4xl md:px-20 min-h-[88.2vh]">
        ...
        <div className=" text-black  flex flex-col items-center p-4 gap-8">
          ...
          <div className="flex md:flex-row flex-col w-full gap-8 justify-between">
            ...
            <div className="relative flex items-center">
              <input ref={passwordref} onChange={handlechange} name="password" id='password' value={form.password} className='rounded-full border border-green-500 w-full py-1 px-4' type="password" placeholder='enter password' />
              <span id='togglePasswordButton' ref={showPasswordRef} onClick={showpassword} className='absolute right-1.5 cursor-pointer '>Show</span>
            </div>
          </div><button onClick={savepassword} className=' gap-2 flex justify-center items-center bg-green-500 rounded-full px-8 py-2 w-fit hover:bg-green-400'>
            <lord-icon
        ...
        <div className="passwords ">
          ...
          {passwordsarray.length === 0 && <div>No passswords to show</div>}
